...
import com.bftcom.ice.datamaps.core.util.JsonFieldDataMapsBuilder
import com.bftcom.ice.datamaps.core.util.differsFrom
import com.bftcom.ice.datamaps.core.util.diffs
...
class DataMapTriggersRegistry {
    ...
    internal fun runTriggers(ops: IdentityHashMap<DeltaBucket, DeltaMachine.DmlType>,
