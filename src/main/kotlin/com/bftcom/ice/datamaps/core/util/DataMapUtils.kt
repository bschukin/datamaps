...
import com.bftcom.ice.datamaps.core.delta.AnyValue
import com.bftcom.ice.datamaps.core.delta.Delta
import com.bftcom.ice.datamaps.core.delta.DeltaType
 ...
 */
internal fun DataMap.diffs(dm: DataMap, recursievly: Boolean = true): List<Delta> {
    if (recursievly)
