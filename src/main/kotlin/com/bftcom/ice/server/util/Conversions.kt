...
import com.bftcom.ice.server.datamaps.GenericDbMetadataService
...
internal class IceDateToDateConverter : Converter<com.bftcom.ice.common.utils.Date, java.sql.Date?> {
...
internal class IceTimestampToTimestampConverter : Converter<com.bftcom.ice.common.utils.Timestamp, java.sql.Timestamp?> {
...
internal class SqlDateToIceDateConverter : Converter<java.sql.Date, com.bftcom.ice.common.utils.Date> {

    override fun convert(source: java.sql.Date?): com.bftcom.ice.common.utils.Date? {
        if (source == null)
            return null
        return com.bftcom.ice.common.utils.Date(source)
    }
}

internal class OracleSqlTimestampToIceTimestampConverter : Converter<oracle.sql.TIMESTAMP, com.bftcom.ice.common.utils.Timestamp> {

    override fun convert(source: oracle.sql.TIMESTAMP?): com.bftcom.ice.common.utils.Timestamp? {
        if (source == null)
            return null
        return com.bftcom.ice.common.utils.Timestamp(source.dateValue())
    }
}

internal class SqlTimestampToIceTimestampConverter : Converter<java.sql.Timestamp, com.bftcom.ice.common.utils.Timestamp> {

    override fun convert(source: java.sql.Timestamp?): com.bftcom.ice.common.utils.Timestamp? {
        if (source == null)
            return null
        return com.bftcom.ice.common.utils.Timestamp(source)
    }
}
