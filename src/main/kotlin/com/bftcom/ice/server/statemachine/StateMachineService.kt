...
import com.bftcom.ice.common.*
import com.bftcom.ice.common.State.getDefaultTransition
import com.bftcom.ice.common.StateMachine.findStartState
import com.bftcom.ice.common.StateMachine.findState
...
import com.bftcom.ice.server.services.CacheClearable
import com.bftcom.ice.server.tools.ServerScriptService
import com.bftcom.ice.server.tools.Var
...
open class StateMachineServiceImpl(val dataService: DataService,
    ...
    private fun DataMapF<StateMachine>.findDefaultTransitionForState(state: DataMapF<State>): DataMapF<Transition> {
        return (this[StateMachine.states].findById(state.id) as DataMapF<State>).getDefaultTransition()
                ?: throwNotFound("The transition from state ${state[{ com.bftcom.ice.common.State.code }]}")
