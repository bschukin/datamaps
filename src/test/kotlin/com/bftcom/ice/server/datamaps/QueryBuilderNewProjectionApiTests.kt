 ...
 */
open class QueryBuilderNewProjectionApiTests : BaseSpringTests() {
    ...
    fun testBuildQuery02() {
        ...
        assertBodyEquals("SELECT \n" +
                ...
                "LEFT JOIN GAME  GAME1 ON PERSON1.FAVORITE_GAME_ID=GAME1.ID \n", q.sql)
    ...
    fun testBuildQuery05() {
        ...
        assertBodyEquals("""
            SELECT
	        DEPARTMENT1.ID  AS  ID1,  DEPARTMENT1.NAME  AS  NAME1,  DEPARTMENT2.ID  AS  ID2,  DEPARTMENT2.NAME  AS  NAME2,  CITY1.ID  AS  ID3,  CITY1.TITLE  AS  TITLE1,  PERSON1.ID  AS  ID4,  PERSON1.NAME  AS  NAME3,  PERSON1.EMAIL  AS  EMAIL1,  PERSON1.LAST_NAME  AS  LAST_NAME1,  PERSON1.AGE  AS  AGE1,  GENDER1.ID  AS  ID5,  GENDER1.NAME  AS  NAME4,  GENDER1.IS_CLASSIC  AS  IS_CLASSIC1,  CITY2.ID  AS  ID6,  CITY2.TITLE  AS  TITLE2, GAME1."ID"  AS  ID7,  GAME1."NAME"  AS  NAME5,  GAME1."METACRITICID"  AS  METACRITICID1
